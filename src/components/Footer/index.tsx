...
const Footer = ({ Title, hash_tag, email, copyright, socialMedia }: Footer) => {
  ...
  return (
    <section
      id={hash_tag}
      className="container pt-15 md:pt-20 flex flex-col justify-start items-start"
    >
      ...
      <div className="flex flex-col justify-start  gap-x-18 gap-y-8 md:gap-y-11 py-10 flex-wrap">
